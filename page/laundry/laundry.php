...
<div class="box">
            ...
            <div class="box-body">             
              ...
              <a href="?page=laundry&aksi=tambah" class="btn btn-info" style="margin-bottom: 10px;" title="">Tambah</a>
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td>
                    <a href="?page=laundry&aksi=ubah&id=<?php echo $data['id_laundry'] ;?>" class="btn btn-success" title=""><i class="fa fa-edit"></i>Ubah</a>
